function [Phi,omega,lambda,b,Xdmd,s] = DMDR(X1,X2,r,dt)
% function [Phi,omega,lambda,b,Xdmd] = DMDR(X1,X2,r,dt)
% Computes the positive Dynamic Mode Decomposition of X1, X2
%
% INPUTS:
% X1 = X, data matrix
